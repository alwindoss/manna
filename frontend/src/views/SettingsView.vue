...
.search-icon { color: var(--ink-light); font-size: 1rem; flex-shrink: 0; }
.nav-search-input {
  flex: 1;
  border: none;
...
.nav-search-input:focus { box-shadow: 0 0 0 2px var(--gold); }
...
.nav-item:hover { background: var(--parchment-mid); color: var(--ink); }
.nav-item.active {
...
.nav-item-icon { font-size: 0.95rem; width: 20px; text-align: center; flex-shrink: 0; }
...
.nav-item-badge.neutral { background: var(--parchment-dark); color: var(--ink-mid); }
.nav-item-badge.warning { background: #f5e6c0; color: #8b6020; }
.nav-item-badge.success { background: #d4edda; color: #2d6a4f; }

.nav-version {
  padding: 12px 16px;
  border-top: 1px solid var(--border-light);
}
.version-text { font-size: 0.72rem; color: var(--ink-light); font-family: sans-serif; }
...
.breadcrumb-root  { font-size: 0.78rem; color: var(--ink-light); }
.breadcrumb-sep   { font-size: 0.78rem; color: var(--ink-light); }
.breadcrumb-current {
  font-size: 0.78rem;
  color: var(--gold);
  font-weight: 600;
...
.section-fade-leave-active { transition: opacity 0.15s ease, transform 0.15s ease; }
.section-fade-enter-from   { opacity: 0; transform: translateX(8px); }
.section-fade-leave-to     { opacity: 0; transform: translateX(-8px); }

/* ── Responsive ───────────────────────────── */
@media (max-width: 768px) {
  .settings-shell { grid-template-columns: 1fr; grid-template-rows: auto 1fr; }
  .settings-nav { border-right: none; border-bottom: 1px solid var(--border); max-height: 200px; }
}
</style>